...
const PAYMENT_API      = "https://api-topup-x410.onrender.com"; // replace with Cloudflare tunnel URL when deployed
...
function renderPackages() {
    ...
    container.innerHTML = packages.map(pkg => `
        <div onclick="selectPackage(${pkg.id})"
            ...
            <div class="flex-1">
                <p class="text-red-500 font-bold text-base leading-tight">
                    $${pkg.price.toFixed(2)}
                </p>
